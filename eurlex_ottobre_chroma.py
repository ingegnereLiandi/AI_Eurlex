...
if os.getenv("COLAB_RELEASE_TAG"):
   print("Running in Colab", os.getenv("COLAB_RELEASE_TAG"))
  #  !rm -rf pytools
  #  !git clone https://github.com/franco-mfg/pytools.git
  #  # usiamo xterm di colab
...
import pytools.sqlitedb as sql
import pytools.utils    as utils
